...
export async function createProduct(product: ProductModel) {
    const data = await $axios.post(config.API_BASE_URL + 'createProduct',product)
        .then(response => {
...
export async function updateProduct(product: ProductModel) {
    const data = await $axios.post(config.API_BASE_URL + 'editProduct',product)
        .then(response => {
            if (response.data.status) {
                return true;
            } 
...
export async function removeProduct(productName: string, productId: number) {
    const data = await $axios.post(config.API_BASE_URL + 'deleteProduct',{
        name: productName,
        id: productId
    })
        .then(response => {
...
export async function trackCalories(product: TrackCaloriesModel) {
    const data = await $axios.post(config.API_BASE_URL + 'track',product)
        .then(response => {
            if (response.data.status) {
                return true;
            } 
...
export async function untrackCalories(productId: number) {
    const data = await $axios.post(config.API_BASE_URL + 'untrack',{ id: productId })
        .then(response => {
            if (response.data.status) {
                return true;
            } 
